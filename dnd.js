		...
		var dnd=(function(global,factory){
			...
			function drop(e){
				...
				if(config_ppal.container!=undefined || config_ppal.container!=null || config_ppal.container!=''){
					...
					contppal_aux=g(config_ppal.container).getEl();
			...
			return {
				config:function(defaults){
					...
					if(config_ppal.container!=undefined || config_ppal.container!=null || config_ppal.container!=''){
						contppal=g(config_ppal.container).getEl();
						...
						if(config_ppal.filefield!=undefined || config_ppal.filefield!=null || config_ppal.filefield!=''){
							iffilefield=1;
							filefield=config_ppal.filefield;
							filefieldobj=g(filefield).getEl();
							filefieldobj.addEventListener('change', changegetfiles);
						}
					}
					else{
